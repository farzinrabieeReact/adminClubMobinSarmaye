...
import { stockDataManagement_insert } from "../../../../../redux/stock/stockDataManagement/stockDataManagement_insert/stockDataManagement_insert";
import {
...
export default function ModalInsertEdit({
  ...
  const handleSubmitInsert = (e, data) => {
    let obj = {};
    ...
    stockDataManagement_insert(obj)
      .then(res => {
  ...
  return (
    <div className={classes.root}>
      ...
      <div className={classes.buttons}>
        <button
          className="btnsGreen"
          onClick={e => handleSubmitInsert(e, data)}
        >
          ثبت
        </button>
...
let initState = {
  ...
  trade_date: { label: null, value: "تاریخ معامله" },
  ...
  symbol_first_trading_date: { label: null, value: "تاریخ اولین معامله نماد " },
