...
import { update_subscriptionPlans_dispatch } from '../../../../../redux/signalHafez/subscriptionPlans/update_subscriptionPlans';
import { active_subscriptionPlans_dispatch } from '../../../../../redux/signalHafez/subscriptionPlans/active_subscriptionPlans';
import { deactivate_subscriptionPlans_dispatch } from '../../../../../redux/signalHafez/subscriptionPlans/deactive_subscriptionPlans';
...
export default function Index({ index, pagnation, stateReducer, head, item, setflagApi }: any) {
    ...
    const handleSubmitEdit = (data: any) => {
        ...
        update_subscriptionPlans_dispatch( _data)
            .then((result: any) => {
    ...
    const handleOkAlertActive = (id: any) => {
        ...
        active_subscriptionPlans_dispatch(_data)
            .then(result => {
                let isOk = handleNotificationAlertTryUpdate(result);
                if (!isOk) {
                    return;
    ...
    const handleOkAlertDeactive = (id: any) => {
        ...
        deactivate_subscriptionPlans_dispatch(_data)
            .then((result: any) => {
                let isOk = handleNotificationAlertTryUpdate(result);
                if (!isOk) {
                    return;
